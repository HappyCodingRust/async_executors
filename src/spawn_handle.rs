...
impl<T: ?Sized, Out> SpawnHandle<Out> for Box<T>
where
    T: SpawnHandle<Out>,
    Out: 'static + Send,
{
...
impl<T: ?Sized, Out> SpawnHandle<Out> for Arc<T>
where
    T: SpawnHandle<Out>,
    Out: 'static + Send,
{
...
impl<T: ?Sized, Out> SpawnHandle<Out> for Rc<T>
where
    T: SpawnHandle<Out>,
    Out: 'static + Send,
{
...
impl<T, Out> SpawnHandle<Out> for &T
where
    T: SpawnHandle<Out>,
    Out: 'static + Send,
{
...
impl<T, Out> SpawnHandle<Out> for &mut T
where
    T: SpawnHandle<Out>,
    Out: 'static + Send,
{
